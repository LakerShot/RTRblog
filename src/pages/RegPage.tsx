      ...
      <div className="form">
        <form className="register-form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <input
            ...
            name="name"
          />
          {errors.name && <span className="no-valid">Login must have at least from 3 to 20 characters</span>}
          <input
          ...
          <input
            ...
            ref={register({
              validate: (value) => value === password.current || 'The passwords do not matches',
            })}
          />
